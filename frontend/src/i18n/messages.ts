  ...
  'zh-CN': {
    ...
    llmManagement: {
      ...
      modelDialog: {
        ...
        costSection: '成本配置',
        costDefaultNote: '默认按人民币计价；如果需要外币，再到高级设置里修改币种和汇率。',
        ...
        costCurrencySectionHint: '只有在需要外币计价时才修改这里。',
  ...
  'en-US': {
    ...
    llmManagement: {
      ...
      modelDialog: {
        ...
        costDefaultNote: 'Default pricing uses CNY. Switch currency and exchange rate only when you need a foreign currency.',
        ...
        costCurrencySectionHint: 'Change this only when the model is priced in a non-CNY currency.',
